...
export function Footer() {
    return (
        <footer className="bg-slate-900 border-t border-white/10 text-white/60">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    {/* Col 1: Logo + tagline */}
                    <div>
                        <div className="text-white font-bold text-xl mb-3">
                            <span className="text-blue-400">Mask</span>Bid
                        </div>
                    ...
                    {/* Col 3: Tech stack */}
                    <div>
                        <h3 className="text-white text-sm font-semibold mb-4">Powered by</h3>
                        <div className="flex flex-wrap gap-2">
                            <span className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 text-white/70 text-xs px-3 py-1.5 rounded-full">
                                World ID
                            </span>
                            <span className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 text-white/70 text-xs px-3 py-1.5 rounded-full">
                                Chainlink
